...
classdef foragingChoiceworldNewExpPanel < eui.ExpPanel
  %FORAGINGCHOICEWORLDEXPPANEL 
  % AP 2017-03-31 created
  % MW 2018-01-01 modified
  % MM 2018-03-02 modified, TO DO: what to plot for choice?
  % plotting panel for foragingChoiceworldExpPanel
  ...
  methods
    function obj = foragingChoiceworldNewExpPanel(parent, ref, params, logEntry)
    ...
    function expUpdate(obj, rig, evt)
      ...
      switch type
        case 'signals' %queue signal updates
          ...
          azimuth = 90; % Starting azimuth is hard-coded in foragingChoiceWorld
...
%       obj.InfoGrid.ColumnSizes = [150, -1];
      ...
      obj.ExperimentAxes.XLim = [-90 90]; % Starting azimuth is hard-coded in foragingChoiceWorld
